...
export default function CustomerSidebar({ activePage }) {
  ...
  const navItems = [
    ...
    { path: '/user/chats', icon: 'comments', label: 'Chats' },
    { path: '/customer/reservations', icon: 'calendar', label: 'Reservations' },
    { path: '', icon: 'sign-out-alt', label: 'Logout', onClick: handleLogout },
  ];
