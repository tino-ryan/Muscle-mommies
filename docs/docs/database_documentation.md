...
- **Collections**: The database consists of eight main collections: `users`, `stores`, `items`, `itemImages`, `Reservations`, `chats`, `messages`, `outfits`, and an additional `externalImages` collection for the external API.
